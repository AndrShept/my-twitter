...
export const Feed = () => {
  const posts = [
    ...
    },
    {
      ...
      content: 'The House of Representatives on Thursday approved President Bola Tinubu’s N500 billion palliative fund to cushion the effect of the removal of fuel subsidy.',
      published: true,
      authorId: '2',
      username: 'Jane Smith',
    ...
    },
    {
      ...
      content: 'The Belgian player signed a contract until June 2028 and is expected to replace Christopher Nkunku, who moved to Chelsea.',
      published: true,
      authorId: '1',
      username: 'Emmy White',
    ...
    },
    {
      ...
      content: 'The majority of the Premier League’s big names have been linked with Lavia. It’s not often a player shines so brightly on their first season of top-flight football that happens.',
      published: true,
      authorId: '3',
  ...
  return (
    <div className='xl:ml-[370px] border-l border-r border-gray-200 xl:min-w-[576px] sm:ml-[73px] max-w-xl'>
